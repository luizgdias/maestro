...
#task = Task(taskId, dataflow_tag, taskName_remove_pipe)
...
#task = Task(taskId, dataflow_tag, taskName_clustalw)
...
#task = Task(taskId, dataflow_tag, taskName_modelgenerator)
...
#task = Task(taskId, dataflow_tag, taskName_read_seq)
#task_input = DataSet(dataflow_tag, [Element(['VALIDATED_SEQUENCE'])])
#task.add_dataset(task_input)
#task.begin()
...
#task = Task(taskId, dataflow_tag, taskName_mrbayes)
