...
# os.system("python programs/mafft.py -INFILE=%s -OUTFILE=%s" % (alignment_input, alignment_output))
# os.system("python programs/model_generator.py -f="+alignment_output+" -gamma="+modelgenerator_gamma)
# os.system("python programs/raxml.py -f="+alignment_output+" -gamma="+modelgenerator_gamma)
#
...
os.system("python sources/programs/act_validation.py")
os.system("python sources/programs/act_alinhamento.py")
os.system("python sources/programs/act_evolutive_model.py")
os.system("python sources/programs/act_conversion.py")
os.system("python sources/programs/act_treegenerator.py")
os.system("python sources/programs/act_validation.py")
os.system("python sources/programs/act_alinhamento.py")
os.system("python sources/programs/act_evolutive_model.py")
os.system("python sources/programs/act_conversion.py")
